...
The function $f(x)=\log_a x$ satisfies 
\[
a^{f(x)} = x 
\]
...
% \problem \groupproblem The AC\textit{ME} company runs two ads on
...
% \problem The population of California grows exponentially at an instantaneous
