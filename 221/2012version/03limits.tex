%% Time-stamp: Wed Dec 19 14:47:00 2012
...
With this commonly given definition we don't have to worry about
...
\begin{figure}[t]
  \framebox{
    \begin{minipage}{0.95\textwidth} \sffamily \null \smallskip
      ...
      because you can never measure anything with infinite precision.
...
\subsection{Definition of limit at $\infty$}
\itshape
...
\begin{figure}[ht]
  \centering
  \input{figures/03ftozeroAtoosmall.tex}

  \input{figures/03ftozeroAok.tex}
...
\marginpar{\footnotesize\sffamily\raggedleft \input{figures/03signOFx.tex}\\[1ex]
  $y=\sign(x)\hfill\null$\\
...
\begin{figure}[ht]\centering
  \input figures/03sinePiOverx.tex
...
\end{equation}%
\marginpar{\input figures/03inverse-of-x.tex }%
...
Since the name of the variable $x$ doesn't matter it is called a dummy
...
The statement may seem obvious, but it still needs a proof, starting from
...
\begin{figure}[h]\centering
  \input figures/03backwardCosSandwich.tex
...
\marginpar{\input figures/03signOFx.tex\\
...
again).
\marginpar{\input figures/03backwardCosSandwichSmall.tex}
...
\begin{figure}[t]
  \framebox{
    \parbox[b]{0.4\textwidth}{\input{figures/03dsin.tex}}
...
\centerline{\input figures/03sinx-over-x.tex}
