...
\end{equation}
\begin{figure}[h]
  \leftline{ \input{figures/09areabetweengraphs-setup.tex}
    \input{figures/09areabetweengraphs2.tex} {\sffamily\footnotesize%
      \input figures/09area-between-graphs-one-slice.pdf_tex } }
...
\begin{quotation}
  ...
  \input figures/09area-between-graphs-Leibniz.pdf_tex } The area of one of
  ...
  \[
    \text{Area} =
    %\mathop{\raisebox{-3pt}{\scalebox{0.9}[2.0]{\bfseries\sffamily S}}}
...
\begin{figure}[ht]
  \centering
  \parbox[b][80pt][t]{190pt}{\input figures/09pyramid2.tex }
  \hspace{35pt}
  \begin{minipage}[t]{130pt}
    \vbox to 80pt{\sffamily%
      \centerline{\bfseries\small Side view of the pyramid} \input
...
If you ignore the fact that the sides of the $k$th slice are slanted (i.e.~not
...
top and its thickness, i.e.  \marginpar{\footnotesize\sffamily\itshape%
  \input figures/09pyramid2-slice.pdf_tex}%
\[
...
\begin{figure}[t]
  \centerline{\input{figures/09Xsections.tex}}
...
\begin{figure}[b]
  \centerline{\input{figures/09Cavalieri.tex}}
...
\begin{figure}[h]\centering
  \parbox{175pt}{\input figures/09surf-of-rotation-profile.tex }
  \parbox{175pt}{\input figures/09surf-of-rotation21.tex }
  \parbox{175pt}{\input figures/09surf-of-rotation2.tex }
...
\begin{figure}[h]\centering
  \input figures/09sliced-sphere.pdf_tex
...
\begin{figure}[ht]\centering
  \parbox{175pt}{\input figures/09surf-of-rotation3-profile.tex }
  \parbox{175pt}{\footnotesize\input figures/09surf-of-rotation3.tex }
...
\begin{figure}[hbt]
  ...
  \begin{minipage}[b]{130pt}
    \vbox to 288pt{\footnotesize\sffamily%
      ...
      \centerline{ \input{figures/09bowlregion.tex} }
...
\end{minipage}%\;\vrule\;
\begin{minipage}[b]{220pt}
  \sffamily\centering \input{figures/09bowl_variation1.tex}
\end{minipage}
\rule{\textwidth}{1pt}
...
\begin{figure}[h]
  ...
  \input{figures/09bowl_variation2.tex}

      \parbox{144pt}{ \vbox to 120pt{
          \includegraphics[width=144pt]{figures/09ring.png}} } \qquad
...
\vbox to 0pt{\hsize130pt\centering%
  \input{figures/09cylindricalSHELL.tex }
...
\begin{figure}[t]\centering
  ...
  \parbox{175pt}{\input{figures/09solidWITHmanyshells.tex} }
  \parbox{175pt}{\input{figures/09solidWITHshells.tex} }
...
\noproblemfont
\begin{figure}[h]
  \centering \input figures/09archimedes-sphere-cone-cylinder.pdf_tex
...
\begin{figure}[h]
  \begin{center}
    \def\svgwidth{240pt} \footnotesize \input figures/09cars.pdf_tex
  \end{center}
\end{figure}
...
\begin{figure}[ht]
  \centering
  \parbox{178pt}{{\input{figures/09arclength.tex}}}
  \parbox{178pt}{{\input{figures/09arclength-Leibniz.tex}}}
...
circle is
\marginpar{\footnotesize\input figures/09motion-on-unitcircle.pdf_tex }%
\[
...
\input figures/05motion-on-a-graph.pdf_tex
}%
...
\subsection{Length of a parabola}
...
more complicated.
\marginpar{\sffamily\itshape\footnotesize\input figures/09motion-on-parabola.pdf_tex \\
Area: $1/3$\\
Length: $\tfrac12 \sqrt{5} + \ln\bigl(2+\sqrt{5}\bigr) $.}%
...
\end{equation}%
\marginpar{\input figures/09how-long-the-sine.pdf_tex}%
...
\input figures/09falling-cars.pdf_tex}
\begin{align*}
...
\]
\vbox to 0pt{\hsize130pt\centering\footnotesize\sffamily\itshape%
  \input figures/09work.pdf_tex }

\hangindent140pt\hangafter-5\noindent%
...
\begin{center}
  \input figures/09once-the-rockets-are-up.pdf_tex
\end{center}
