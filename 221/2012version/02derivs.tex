%%Time-stamp: Aug  6 10:11 02derivs.tex
...
\begin{figure}[h]\centering
  \input{figures/02constructingTheTangent.tex}
...
\begin{center}
  \includegraphics[width=0.7\textwidth]{figures/02DeltaxDeltay.pdf}
\end{center}
...
\begin{figure}[h]
  \includegraphics[width=0.6\textwidth]{figures/02car.png}
  %\centering \input figures/02car.tex
\end{figure}
