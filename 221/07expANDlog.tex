% Time-stamp: Aug  6 10:14 07expANDlog.tex
% !TEX root =  free221.tex


% Add your name and the date here if you've done something
% Evan, fixed typos and some wording, 12/23



% !!! Discuss: Break up this chapter and integrate it with the earlier chapters
% in the text. Specific proposal:
% Move the basics (exponents, logs, properties of logs, graphs) to the
% introductory chapter.
% Move the discussion of arbitrary exponentials to the limits chapter.
% Move the discussion of the derivatives to its own section after the
% derivatives of sine and cosine.
% Move exponential growth and decay to the "applications of derivatives" chapter.
% Move exercises where appropriate, and add lots of logs and exponentials to
